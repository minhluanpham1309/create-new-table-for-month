...
variable "valkey_manage_allowed_security_group_ingress_rules" {
  description = "Whether Terraform should manage Valkey ingress rules for allowed_security_group_ids"
  type        = bool
  default     = true
}
